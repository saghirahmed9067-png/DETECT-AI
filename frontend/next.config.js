  ...
  headers: async () => [
    {
      ...
      headers: [
        ...
        { key: 'Strict-Transport-Security',value: 'max-age=31536000; includeSubDomains' },
        {
          ...
          value: [
            "default-src 'self'",
            "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://apis.google.com https://accounts.google.com https://*.clerk.accounts.dev https://*.clerk.com https://js.clerk.dev https://cdn.jsdelivr.net",
