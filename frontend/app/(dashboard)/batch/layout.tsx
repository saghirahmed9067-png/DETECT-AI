...
export const metadata: Metadata = {
  ...
  description: 'Upload and analyze up to 20 files simultaneously. Detect AI-generated text, images, audio, and video in parallel. Free batch AI detection — no credit card required.',
