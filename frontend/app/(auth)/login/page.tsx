...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#06060e] flex flex-col items-center justify-center p-4 relative overflow-hidden">
        ...
        <SignIn
          ...
          appearance={{
            ...
            elements: {
              ...
              // Social buttons (Google — placed at BOTTOM via layout)
              ...
              // Footer (Clerk's built-in "Don't have an account?" link)
              footer: 'hidden',  // hide Clerk's footer — we show our own below
              footerAction: 'hidden',
      ...
      {/* Our own single footer link — replaces Clerk's */}
