...
const TESTIMONIAL = {
  text: '"Aiscern is the most accurate AI detector I\'ve used. Detected ChatGPT rewrites that other tools missed."',
  author: '— Editor, major news publication',
}
...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-[#07070f] flex">
      ...
      <div className="hidden lg:flex lg:w-[480px] xl:w-[560px] flex-col justify-between p-12 bg-[#0d0d1f] border-r border-white/5 relative overflow-hidden">
        ...
        <div className="space-y-8 relative z-10">
          <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-4 py-1.5">
            ...
            <span className="text-xs text-text-muted font-medium">Free forever — no credit card</span>
          </div>
          ...
          <div>
            ...
            <h2 className="text-4xl font-black text-primary leading-tight">in seconds</h2>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-5">
            ...
            <p className="text-text-disabled text-xs">{TESTIMONIAL.author}</p>
          </div>
      ...
      {/* Right panel — Clerk SignUp embedded */}
